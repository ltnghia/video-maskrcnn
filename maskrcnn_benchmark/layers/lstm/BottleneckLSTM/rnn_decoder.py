...
def rnn_decoder(decoder_inputs,
                ...
                loop_function=None,
                scope=None):
  """RNN decoder_heads for the sequence-to-sequence model.

  This decoder_heads returns a list of all states, rather than only the final state.
  Args:
