...
# Cityscapes modules
try:
    from maskrcnn_benchmark.external.cityscapesscripts.helpers.annotation import Annotation
    from maskrcnn_benchmark.external.cityscapesscripts.helpers.labels import labels, name2label, id2label, trainId2label, category2labels
