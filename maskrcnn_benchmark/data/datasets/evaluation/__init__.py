...
from .coco.coco_eval import do_coco_evaluation as do_orig_coco_evaluation
from .coco.coco_eval_wrapper import do_coco_evaluation as do_wrapped_coco_evaluation
