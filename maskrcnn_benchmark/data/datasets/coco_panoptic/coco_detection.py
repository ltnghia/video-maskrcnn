...
class COCODetectionDataset(torchvision.datasets.coco.CocoDetection):
    def __init__(
        self, ann_file, root, remove_images_without_annotations, transforms=None
    ):
        super(COCODetectionDataset, self).__init__(root, ann_file)
    ...
    def __getitem__(self, idx):
        img, anno = super(COCODetectionDataset, self).__getitem__(idx)
