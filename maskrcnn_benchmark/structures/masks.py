...
class BinaryMasks(object):
    ...
    def __init__(self, masks, size):
        ...
        elif isinstance(masks, BinaryMasks):
    ...
    def transpose(self, method):
        ...
        return BinaryMasks(flipped_masks, self.size)
    ...
    def crop(self, box):
        ...
        return BinaryMasks(cropped_masks, cropped_size)
    ...
    def resize(self, size):
        ...
        return BinaryMasks(resized_masks, resized_size)

    def convert_to_polygon(self):
        if self.masks.numel() == 0:
            return Polygons([], self.size)

        contours = self._findContours()
        return Polygons(contours, self.size)
    ...
    def __getitem__(self, index):
        ...
        return BinaryMasks(self.masks[index], self.size)
...
class Polygons(object):
    ...
    def transpose(self, method):
        ...
        return Polygons(flipped_polygons, size=self.size)
    ...
    def crop(self, box):
        ...
        cropped_size = w, h
        return Polygons(cropped_polygons, cropped_size)
    ...
    def resize(self, size):
        ...
        resized_size = size
        return Polygons(resized_polygons, resized_size)
    ...
    def convert_to_binarymask(self):
        ...
        return BinaryMasks(masks, size=self.size)
    ...
    def __getitem__(self, item):
        ...
        return Polygons(selected_polygons, size=self.size)
...
class SegmentationMask(object):
    ...
    It wraps BinaryMasks and Polygons conveniently.
    """
    ...
    def __init__(self, instances, size, mode="poly"):
        ...
        if mode == "poly":
            self.instances = Polygons(instances, size)
        elif mode == "mask":
            self.instances = BinaryMasks(instances, size)
        else:
