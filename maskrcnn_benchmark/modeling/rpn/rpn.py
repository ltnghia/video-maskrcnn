...
class RPNHeadConvRegressor(nn.Module):
    ...
    def __init__(self, cfg, in_channels, num_anchors):
        ...
        if cfg.MODEL.RPN.USE_FOCAL_LOSS:
            ...
            prior_prob = cfg.MODEL.RPN.PRIOR_PROB
...
class RPNModule(nn.Module):
    ...
    def forward(self, images, features, targets=None, extended_features=None):
        """
        Arguments:
        ...
        if self.use_extended_features and extended_features is not None:
