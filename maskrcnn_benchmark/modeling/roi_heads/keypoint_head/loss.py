...
from maskrcnn_benchmark.modeling.sampler.balanced_positive_negative_sampler import (
...
from maskrcnn_benchmark.structures.keypoints import keypoints_to_heat_map
...
class KeypointRCNNLossComputation(object):
    ...
    def __call__(self, proposals, keypoint_logits):
        ...
        keypoint_loss = F.cross_entropy(keypoint_logits[valid], keypoint_targets[valid], reduction='mean')
