...
class MaskRCNNLossComputation(object):
    def __init__(self, proposal_matcher, discretization_size, maskiou_on=False, use_negative_samples=False):
        """
        Arguments:
    ...
    def match_targets_to_proposals(self, proposal, target):
        ...
        if self.use_negative_samples and len(target) == 0:
            ...
            matched_targets.add_field("masks", matched_idxs.clamp(min=1, max=1))
        else:
    ...
    def prepare_targets(self, proposals, targets):
        ...
        for proposals_per_image, targets_per_image in zip(proposals, targets):
            ...
            if self.use_negative_samples and len(matched_targets) == 0:
                ...
                masks_per_image = torch.stack((zeros, zeros, zeros, zeros), dim=1)
            else:
    ...
    def __call__(self, proposals, mask_logits, targets):
        ...
        mask_loss = F.binary_cross_entropy_with_logits(
            mask_logits[positive_inds, labels_pos], mask_targets, reduction='mean'
        )
